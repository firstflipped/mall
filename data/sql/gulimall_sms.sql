...
-- ----------------------------
BEGIN;
INSERT INTO `sms_member_price` (`id`, `sku_id`, `member_level_id`, `member_level_name`, `member_price`, `add_other`) VALUES (1, 1, 2, '白银会员', 5699.0000, NULL);
INSERT INTO `sms_member_price` (`id`, `sku_id`, `member_level_id`, `member_level_name`, `member_price`, `add_other`) VALUES (2, 1, 3, '黄金会员', 5599.0000, NULL);
INSERT INTO `sms_member_price` (`id`, `sku_id`, `member_level_id`, `member_level_name`, `member_price`, `add_other`) VALUES (3, 1, 4, '钻石会员', 5499.0000, NULL);
COMMIT;
...
CREATE TABLE `sms_sec_kill_promotion` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='秒杀活动';

-- ----------------------------
-- Records of sms_sec_kill_promotion
-- ----------------------------
BEGIN;
INSERT INTO `sms_sec_kill_promotion` (`id`, `title`, `start_time`, `end_time`, `status`, `create_time`, `user_id`) VALUES (3, 'ceshi', '2021-11-11 00:00:00', '2021-12-01 00:00:00', 1, '2021-11-10 10:55:34', NULL);
COMMIT;
...
CREATE TABLE `sms_sec_kill_session` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='秒杀活动场次';

-- ----------------------------
-- Records of sms_sec_kill_session
-- ----------------------------
BEGIN;
INSERT INTO `sms_sec_kill_session` (`id`, `name`, `start_time`, `end_time`, `status`, `create_time`) VALUES (1, 'xxx', '2021-11-16 16:00:00', '2021-11-16 18:00:00', 1, '2021-11-10 16:10:25');
INSERT INTO `sms_sec_kill_session` (`id`, `name`, `start_time`, `end_time`, `status`, `create_time`) VALUES (2, 'yyy', '2021-11-17 03:30:00', '2021-11-17 08:00:00', 1, '2021-11-16 09:35:40');
INSERT INTO `sms_sec_kill_session` (`id`, `name`, `start_time`, `end_time`, `status`, `create_time`) VALUES (3, 'jjj', '2021-11-22 08:30:00', '2021-11-22 23:00:00', 1, '2021-11-16 10:52:43');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sms_sec_kill_sku_relation` (`id`, `promotion_id`, `promotion_session_id`, `sku_id`, `sec_kill_price`, `sec_kill_count`, `sec_kill_limit`, `sec_kill_sort`) VALUES (2, NULL, 1, 41, 3999, 1, 1, 0);
INSERT INTO `sms_sec_kill_sku_relation` (`id`, `promotion_id`, `promotion_session_id`, `sku_id`, `sec_kill_price`, `sec_kill_count`, `sec_kill_limit`, `sec_kill_sort`) VALUES (3, NULL, 2, 41, 4999, 10, 1, 0);
INSERT INTO `sms_sec_kill_sku_relation` (`id`, `promotion_id`, `promotion_session_id`, `sku_id`, `sec_kill_price`, `sec_kill_count`, `sec_kill_limit`, `sec_kill_sort`) VALUES (4, NULL, 3, 41, 4299, 100, 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sms_sku_full_reduction` (`id`, `sku_id`, `full_price`, `reduce_price`, `add_other`) VALUES (1, 1, 1000.0000, 20.0000, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sms_sku_ladder` (`id`, `sku_id`, `full_count`, `discount`, `price`, `add_other`) VALUES (1, 1, 2, 1.00, NULL, 0);
COMMIT;
...
CREATE TABLE `sms_spu_bounds` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品spu积分设置';

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
BEGIN;
INSERT INTO `sms_spu_bounds` (`id`, `spu_id`, `grow_bounds`, `buy_bounds`, `work`) VALUES (4, 7, 5000.0000, 5000.0000, NULL);
INSERT INTO `sms_spu_bounds` (`id`, `spu_id`, `grow_bounds`, `buy_bounds`, `work`) VALUES (5, 8, 9.0000, 9.0000, NULL);
INSERT INTO `sms_spu_bounds` (`id`, `spu_id`, `grow_bounds`, `buy_bounds`, `work`) VALUES (6, 12, 9.0000, 9.0000, NULL);
INSERT INTO `sms_spu_bounds` (`id`, `spu_id`, `grow_bounds`, `buy_bounds`, `work`) VALUES (7, 13, 9.0000, 9.0000, NULL);
INSERT INTO `sms_spu_bounds` (`id`, `spu_id`, `grow_bounds`, `buy_bounds`, `work`) VALUES (8, 14, 10.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` (`id`, `spu_id`, `grow_bounds`, `buy_bounds`, `work`) VALUES (9, 15, 10.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` (`id`, `spu_id`, `grow_bounds`, `buy_bounds`, `work`) VALUES (10, 16, 1.0000, 1.0000, NULL);
INSERT INTO `sms_spu_bounds` (`id`, `spu_id`, `grow_bounds`, `buy_bounds`, `work`) VALUES (11, 17, 1000.0000, 1000.0000, NULL);
INSERT INTO `sms_spu_bounds` (`id`, `spu_id`, `grow_bounds`, `buy_bounds`, `work`) VALUES (12, 18, 1000.0000, 1000.0000, NULL);
COMMIT;
