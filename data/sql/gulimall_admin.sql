...
CREATE TABLE `sys_permission` (
  ...
  `status` tinyint(1) DEFAULT NULL COMMENT '删除状态 1已启用 0未启用',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_permission` (`permission_id`, `permission_name`, `permission_value`, `url`, `parent_id`, `type`, `icon`, `sort_no`, `status`, `description`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1466209998387417088, '用户管理', 'admin:user', 'www.baidu.com', 0, 1, NULL, 1, NULL, NULL, NULL, '2021-12-02 08:57:59', NULL, NULL);
INSERT INTO `sys_permission` (`permission_id`, `permission_name`, `permission_value`, `url`, `parent_id`, `type`, `icon`, `sort_no`, `status`, `description`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1466211572253855744, '角色管理', 'admin:role', 'www.baidu.com', 0, 1, NULL, 1, NULL, NULL, NULL, '2021-12-02 09:04:14', NULL, NULL);
INSERT INTO `sys_permission` (`permission_id`, `permission_name`, `permission_value`, `url`, `parent_id`, `type`, `icon`, `sort_no`, `status`, `description`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1466211672942317568, '权限管理', 'admin:permission', 'www.baidu.com', 0, 1, NULL, 1, NULL, NULL, NULL, '2021-12-02 09:04:38', NULL, NULL);
INSERT INTO `sys_permission` (`permission_id`, `permission_name`, `permission_value`, `url`, `parent_id`, `type`, `icon`, `sort_no`, `status`, `description`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1466212316054949888, '用户添加', 'admin:user:add', 'www.baidu.com', 1466209998387417088, 2, NULL, 1, NULL, NULL, NULL, '2021-12-02 09:07:12', NULL, NULL);
INSERT INTO `sys_permission` (`permission_id`, `permission_name`, `permission_value`, `url`, `parent_id`, `type`, `icon`, `sort_no`, `status`, `description`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1466212464789164032, '角色添加', 'admin:role:add', 'www.baidu.com', 1466211572253855744, 2, NULL, 1, NULL, NULL, NULL, '2021-12-02 09:07:47', NULL, NULL);
COMMIT;
...
CREATE TABLE `sys_platform_log` (
  ...
  `request_method` char(8) DEFAULT NULL,
  ...
  `method_type` tinyint DEFAULT NULL COMMENT '请求类型 增1删2改3查4',
...
) ENGINE=MyISAM AUTO_INCREMENT=1516320405984661512 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='系统日志表';
...
CREATE TABLE `sys_role_permission` (
  ...
  `operate_ip` int DEFAULT NULL COMMENT '操作ip',
...
INSERT INTO `sys_user` (`userid`, `username`, `real_name`, `password`, `avatar`, `birthday`, `gender`, `email`, `phone`, `status`, `delete`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES ('1493470195535187968', 'root', '超级管理员', '$2a$10$ozeJUCSnnQZmx5/LPbqO7ueKtXz2cORvm4NiZ2Y38t3i33s/gQmDm', 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fup.enterdesk.com%2Fedpic%2F69%2F5f%2Fa7%2F695fa728c162c2cb073d7e0079dfdee5.jpeg&refer=http%3A%2F%2Fup.enterdesk.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1647497570&t=ec87f37033839d93bfc8b10be8031e31', '1998-08-20', 0, '0000000@163.com', '13312345678', 1, 0, 'admin', '2022-02-15 14:20:17', NULL, NULL);
