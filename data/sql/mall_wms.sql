/*
 ...
 Date: 31/10/2022 15:45:27
*/
CREATE DATABASE IF NOT EXISTS `mall_wms` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
USE `mall_wms`;
...
INSERT INTO `wms_purchase` (`id`, `assignee_id`, `assignee_name`, `phone`, `priority`, `status`, `ware_id`, `amount`,
                            `create_time`, `update_time`)
VALUES (2, 1, 'admin', '13612345678', NULL, 3, NULL, NULL, '2021-04-29 23:48:33', '2021-04-29 23:50:23');
COMMIT;
...
INSERT INTO `wms_purchase_detail` (`id`, `purchase_id`, `sku_id`, `sku_num`, `sku_price`, `ware_id`, `status`)
VALUES (2, 1, 2, 100, NULL, 4, 4);
INSERT INTO `wms_purchase_detail` (`id`, `purchase_id`, `sku_id`, `sku_num`, `sku_price`, `ware_id`, `status`)
VALUES (3, 2, 3, 100, NULL, 3, 3);
INSERT INTO `wms_purchase_detail` (`id`, `purchase_id`, `sku_id`, `sku_num`, `sku_price`, `ware_id`, `status`)
VALUES (4, 2, 4, 100, NULL, 3, 3);
COMMIT;
...
INSERT INTO `wms_ware_info` (`id`, `name`, `address`, `area_code`, `create_time`, `update_time`)
VALUES (4, '东北一仓', '吉林省大连市北京北路', '119120', NULL, NULL);
COMMIT;
...
INSERT INTO `wms_ware_order_task` (`id`, `order_id`, `order_sn`, `consignee`, `consignee_tel`, `delivery_address`,
                                   ...
                                   `ware_id`, `task_comment`, `create_time`)
VALUES (12, NULL, '202110262154408461452997109169709058', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL);
INSERT INTO `wms_ware_order_task` (`id`, `order_id`, `order_sn`, `consignee`, `consignee_tel`, `delivery_address`,
                                   `order_comment`, `payment_way`, `task_status`, `order_body`, `tracking_no`,
                                   `ware_id`, `task_comment`, `create_time`)
VALUES (13, NULL, '202110262317075141453017856931966978', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL);
COMMIT;
...
INSERT INTO `wms_ware_order_task_detail` (`id`, `sku_id`, `sku_name`, `sku_num`, `task_id`, `ware_id`, `lock_status`)
VALUES (13, 41, 'Apple iPhone 12 (A2404) 128GB 绿色 支持移动联通电信5G 双卡双待手机 黑色 4G', 2, 13, 3, 1);
COMMIT;
...
INSERT INTO `wms_ware_sku` (`id`, `sku_id`, `ware_id`, `stock`, `sku_name`, `stock_locked`)
VALUES (2, 42, 3, 0, 'Apple iPhone 12 (A2404) 128GB 绿色 支持移动联通电信5G 双卡双待手机 黑色 6G', 0);
INSERT INTO `wms_ware_sku` (`id`, `sku_id`, `ware_id`, `stock`, `sku_name`, `stock_locked`)
VALUES (3, 42, 4, 20, 'Apple iPhone 12 (A2404) 128GB 绿色 支持移动联通电信5G 双卡双待手机 黑色 6G', 0);
INSERT INTO `wms_ware_sku` (`id`, `sku_id`, `ware_id`, `stock`, `sku_name`, `stock_locked`)
VALUES (4, 43, 4, 100, 'Apple iPhone 12 (A2404) 128GB 绿色 支持移动联通电信5G 双卡双待手机 白色 4G', 0);
COMMIT;
