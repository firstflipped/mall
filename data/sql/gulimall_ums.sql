...
CREATE TABLE `ums_member` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='会员';

-- ----------------------------
-- Records of ums_member
-- ----------------------------
BEGIN;
INSERT INTO `ums_member` (`id`, `level_id`, `username`, `password`, `nickname`, `mobile`, `email`, `header`, `gender`, `birth`, `city`, `job`, `sign`, `source_type`, `integration`, `growth`, `status`, `social_uid`, `access_token`, `expires_in`, `create_time`) VALUES (2, 1, 'wangjie', '$2a$10$6gKu6vmpTFQUtEczpX5bdOItBTKuLLOnFpjc53sX1Zps7lCJ0.n82', NULL, '18763096838', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-27 23:01:35');
INSERT INTO `ums_member` (`id`, `level_id`, `username`, `password`, `nickname`, `mobile`, `email`, `header`, `gender`, `birth`, `city`, `job`, `sign`, `source_type`, `integration`, `growth`, `status`, `social_uid`, `access_token`, `expires_in`, `create_time`) VALUES (4, 1, 'admin', '$2a$10$ekdVeZ8K5cQg1dKSbaUyNudomVMex8KkPA8ztUAm8iNMNZxyxGVkm', NULL, '17515235623', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-27 23:41:09');
INSERT INTO `ums_member` (`id`, `level_id`, `username`, `password`, `nickname`, `mobile`, `email`, `header`, `gender`, `birth`, `city`, `job`, `sign`, `source_type`, `integration`, `growth`, `status`, `social_uid`, `access_token`, `expires_in`, `create_time`) VALUES (5, 1, NULL, '$2a$10$WHcNFkpxhOQer.UHE4FT6uyyUZxmDFP895BnJjy8w7.tJ0dRgjkB.', '心有猛虎的杰爷', NULL, NULL, 'https://tva4.sinaimg.cn/crop.0.0.1080.1080.50/006evlUgjw8fbuphxbojoj30u00u0jrs.jpg?KID=imgbed,tva&Expires=1629309063&ssig=JnKnMHkqmm', 1, NULL, '16', NULL, NULL, NULL, NULL, NULL, NULL, 5711138076, '2.00Qu2VOGppkbeC8f7ac62209LyPwxD', 157679999, '2021-08-18 22:51:04');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `ums_member_level` (`id`, `name`, `growth_point`, `default_status`, `free_freight_point`, `comment_growth_point`, `free_freight_privilege`, `member_price_privilege`, `birthday_privilege`, `note`) VALUES (1, '普通会员', 0, 1, 1000.0000, 10, 0, 0, 0, '普通会员');
INSERT INTO `ums_member_level` (`id`, `name`, `growth_point`, `default_status`, `free_freight_point`, `comment_growth_point`, `free_freight_privilege`, `member_price_privilege`, `birthday_privilege`, `note`) VALUES (2, '白银会员', 5000, 0, 1000.0000, 20, 0, 1, 1, '白银会员');
INSERT INTO `ums_member_level` (`id`, `name`, `growth_point`, `default_status`, `free_freight_point`, `comment_growth_point`, `free_freight_privilege`, `member_price_privilege`, `birthday_privilege`, `note`) VALUES (3, '黄金会员', 10000, 0, 500.0000, 30, 0, 1, 1, '黄金会员');
INSERT INTO `ums_member_level` (`id`, `name`, `growth_point`, `default_status`, `free_freight_point`, `comment_growth_point`, `free_freight_privilege`, `member_price_privilege`, `birthday_privilege`, `note`) VALUES (4, '钻石会员', 100000, 0, 500.0000, 50, 1, 1, 1, '钻石会员');
COMMIT;
...
CREATE TABLE `ums_member_receive_address` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='会员收货地址';

-- ----------------------------
-- Records of ums_member_receive_address
-- ----------------------------
BEGIN;
INSERT INTO `ums_member_receive_address` (`id`, `member_id`, `name`, `phone`, `post_code`, `province`, `city`, `region`, `detail_address`, `area_code`, `default_status`) VALUES (1, 5, '山东舞王小阿靠', '17515235623', '0000', '山东省', '济南市', '历下区', '舜华路街道草山岭小区', NULL, 1);
INSERT INTO `ums_member_receive_address` (`id`, `member_id`, `name`, `phone`, `post_code`, `province`, `city`, `region`, `detail_address`, `area_code`, `default_status`) VALUES (2, 5, '山东舞王小阿靠', '17515235623', '9999', '北京市', '北京市', '东城区', '长安街1号', NULL, 0);
INSERT INTO `ums_member_receive_address` (`id`, `member_id`, `name`, `phone`, `post_code`, `province`, `city`, `region`, `detail_address`, `area_code`, `default_status`) VALUES (3, 5, '山东舞王小阿靠', '17515235623', '2222', '山东省', '青岛市', '市南区', '济南路66号', NULL, 0);
COMMIT;
