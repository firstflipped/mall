...
import com.flipped.mall.common.constant.ProductConstants;
import com.flipped.mall.common.entity.api.MyPage;
import com.flipped.mall.common.entity.api.MyResult;
import com.flipped.mall.common.util.JsonUtil;
import com.flipped.mall.product.dao.SpuInfoDao;
import com.flipped.mall.product.entity.*;
import com.flipped.mall.product.entity.dto.SkuEsDTO;
import com.flipped.mall.product.entity.dto.SkuOtherInfoDTO;
import com.flipped.mall.product.entity.dto.SpuBoundDTO;
import com.flipped.mall.product.entity.param.*;
...
import com.flipped.mall.product.feign.service.SearchFeignService;
import com.flipped.mall.product.feign.service.WareFeignService;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    private void saveSpuBounds(Long spuInfoId, SpuBoundParam bound) {
        ...
        if (!saveSpuBoundsResult.getSuccess()) {
    ...
    private void saveSkuOther(Long skuId, SkuParam sku) {
        ...
        if (skuOtherInfoDTO.getFullCount() > 0 && (skuOtherInfoDTO.getFullPrice().compareTo(BigDecimal.ZERO) > 0)) {
            ...
            if (!saveSkuOtherInfoResult.getSuccess()) {
